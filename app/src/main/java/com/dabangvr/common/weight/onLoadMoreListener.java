...
/*        if (newState==SCROLL_STATE_IDLE){
            Log.d("activity_camera","SCROLL_STATE_IDLE,空闲");
        }
        else if (newState==SCROLL_STATE_DRAGGING){
            Log.d("activity_camera","SCROLL_STATE_DRAGGING,拖拽");
        }
        else if (newState==SCROLL_STATE_SETTLING){
            Log.d("activity_camera","SCROLL_STATE_SETTLING,固定");
        }
        else{
            Log.d("activity_camera","其它");
        }*/
