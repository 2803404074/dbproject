...
import com.dabangvr.util.MTimeUtils;
/**
 * 播放器  控制器：
 */
public class MmediaController {
    ...
    public MmediaController setText(TextView showView) {
...
//                    Animation operatingAnim = AnimationUtils.loadAnimation(activity, R.anim.lodding);
//                    operatingAnim.setInterpolator(new AccelerateDecelerateInterpolator());
//                    showView.startAnimation(operatingAnim);
