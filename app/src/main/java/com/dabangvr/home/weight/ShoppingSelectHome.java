 ...
 * 描述:TODO 商品规格选择View
 */
public class ShoppingSelectHome<T> extends LinearLayout {
    private boolean OK;
    ...
    public ShoppingSelectHome(Context context) {
        super(context);
        initView(context);
    }

    public ShoppingSelectHome(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private boolean hasSpe = true;

    public boolean getHasSpe(){
        return hasSpe;
    }
...
//            }
    ...
    public void setDataa(List<T> data) {
        list = (List<GoodsDetails.GoodsSpecVoList>) data;
        getView();
    }
     ...
     */
    public void setTextViewAndGGproject(int type, TextView number, TextView countPrice, TextView clike, TextView stock, List<GoodsDetails.ProductInfoVoList> productInfo) {
        this.type = type;
        this.number = number;
    ...
    public void setTextViewAndGGproject(TextView number, TextView countPrice, TextView clike, TextView stock, List<GoodsDetails.ProductInfoVoList> productInfo) {
        this.type = 1;
        this.number = number;
        this.countPrice = countPrice;
        this.stock = stock;
