...
import com.dabangvr.video.widget.FrameListView;
import com.dabangvr.video.widget.FrameSelectorView;
import com.dabangvr.video.widget.ImageSelectorPanel;
import com.dabangvr.video.widget.PaintSelectorPanel;
import com.dabangvr.video.widget.SectionProgressBar;
import com.dabangvr.video.widget.StrokedTextView;
import com.dabangvr.video.widget.TextSelectorPanel;
import com.dabangvr.video.widget.AudioMixSettingDialog;
...
public class VideoEditActivity extends Activity implements PLVideoSaveListener {
    ...
    public static VideoEditActivity instance;
    ...
    private PLWatermarkSetting createWatermarkSetting() {
        ...
        watermarkSetting.setResourceId(R.mipmap.app_lital);
    ...
    private void showTextViewBorder(PLTextView textView) {
        ...
        mCurTextView.setBackgroundResource(R.drawable.h_shape);
    ...
    private void showImageViewBorder(PLImageView imageView) {
        ...
        mCurImageView.setBackgroundResource(R.drawable.h_shape);
