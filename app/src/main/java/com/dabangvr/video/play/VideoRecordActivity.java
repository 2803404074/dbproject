package com.dabangvr.video.play;
...
import com.dabangvr.video.utils.Config;
import com.dabangvr.video.utils.GetPathFromUri;
import com.dabangvr.video.utils.ToastUtils;
import com.dabangvr.video.widget.CustomProgressDialog;
import com.dabangvr.video.widget.FocusIndicator;
import com.dabangvr.video.widget.RecordSettings;
import com.dabangvr.video.widget.SectionProgressBar;
...
import static com.dabangvr.video.widget.RecordSettings.RECORD_SPEED_ARRAY;
...
//        mMicrophoneSetting.setChannelConfig(RecordSettings.AUDIO_CHANNEL_NUM_ARRAY[1] == 1 ?
//                AudioFormat.CHANNEL_IN_MONO : AudioFormat.CHANNEL_IN_STEREO);
        ...
        mVideoEncodeSetting.setEncodingBitrate(1000 * 1024);
        ...
        mRecordSetting.setMaxRecordDuration(RecordSettings.DEFAULT_MAX_RECORD_DURATION2);
        ...
        //美颜
        mFaceBeautySetting = new PLFaceBeautySetting(mp, mb, hr);
        ...
        //点击美颜
        findViewById(R.id.tv_butty).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottomSheetDialog dialog = new BottomSheetDialog(VideoRecordActivity.this);
                View bottomView = LayoutInflater.from(VideoRecordActivity.this).inflate(R.layout.seekbar_dialog, null);
                ...
                seekMp.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        mFaceBeautySetting.setBeautyLevel(progress / 100.0f);
                ...
                seekMb.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                    @Override
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        mFaceBeautySetting.setWhiten(progress / 100.0f);
                        mShortVideoRecorder.updateFaceBeautySetting(mFaceBeautySetting);
                        mb = progress;
                    }
                ...
                seekHr.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                    @Override
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        mFaceBeautySetting.setRedden(progress / 100.0f);
                        mShortVideoRecorder.updateFaceBeautySetting(mFaceBeautySetting);
                        hr = progress;
                    }
                ...
                dialog.contentView(bottomView)/*加载视图*/
                        .inDuration(200)
                        .outDuration(200)
                        .cancelable(true)
                        .show();
...
//    }
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton(getString(R.string.dlg_save_draft_yes), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (mShortVideoRecorder.saveToDraftBox(editText.getText().toString())) {
    ...
    public void onSpeedClicked(View view) {
        ...
        if (mRecordSetting.IsRecordSpeedVariable() && mVideoEncodeSetting.IsConstFrameRateEnabled()) {
            ...
            mRecordSetting.setMaxRecordDuration((long) (RecordSettings.DEFAULT_MAX_RECORD_DURATION2 * mRecordSpeed));
