...
import com.dabangvr.lbroadcast.utils.Config;
...
public class PLVideoTextureActivity extends VideoPlayerBaseActivity {
    ...
    public void onClickSwitchScreen(View v) {
        ...
        switch (mVideoView.getDisplayAspectRatio()) {
            case PLVideoTextureView.ASPECT_RATIO_ORIGIN:
                ToastUtil.showShort(PLVideoTextureActivity.this, "Origin mode");
                break;
            case PLVideoTextureView.ASPECT_RATIO_FIT_PARENT:
                ToastUtil.showShort(PLVideoTextureActivity.this, "Fit parent !");
                break;
            case PLVideoTextureView.ASPECT_RATIO_PAVED_PARENT:
                ToastUtil.showShort(PLVideoTextureActivity.this, "Paved parent !");
                break;
            case PLVideoTextureView.ASPECT_RATIO_16_9:
                ToastUtil.showShort(PLVideoTextureActivity.this, "16 : 9 !");
                break;
            case PLVideoTextureView.ASPECT_RATIO_4_3:
                ToastUtil.showShort(PLVideoTextureActivity.this, "4 : 3 !");
                break;
            default:
                break;
        }
        ...
        public void onInfo(int what, int extra) {
            ...
            switch (what) {
                ...
                case PLOnInfoListener.MEDIA_INFO_VIDEO_RENDERING_START:
                    ToastUtil.showShort(PLVideoTextureActivity.this, "First video render time: " + extra + "ms");
                    break;
        ...
        public boolean onError(int errorCode) {
            ...
            switch (errorCode) {
                case PLOnErrorListener.ERROR_CODE_IO_ERROR:
                     ...
                     */
                    ToastUtil.showShort(PLVideoTextureActivity.this, "IO Error !");
                    return false;
                case PLOnErrorListener.ERROR_CODE_OPEN_FAILED:
                    ToastUtil.showShort(PLVideoTextureActivity.this, "failed to open player !");
                    break;
                case PLOnErrorListener.ERROR_CODE_SEEK_FAILED:
                    ToastUtil.showShort(PLVideoTextureActivity.this, "failed to seek !");
                    return true;
                default:
                    ToastUtil.showShort(PLVideoTextureActivity.this, "unknown error !");
                    break;
            }
            finish();
            return true;
    ...
    private PLOnCompletionListener mOnCompletionListener = new PLOnCompletionListener() {
        ...
        public void onCompletion() {
            ...
            ToastUtil.showShort(PLVideoTextureActivity.this, "Play Completed !");
            finish();
        }
    };
