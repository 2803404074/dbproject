...
import com.dbvr.imglibrary.ui.adapter.ImageAdapter;
import com.dbvr.imglibrary.ui.adapter.ImageFolderAdapter;
import com.dbvr.imglibrary.utils.StatusBarUtil;
import com.dbvr.imglibrary.utils.TDevice;
import com.dbvr.imglibrary.widget.ImageFolderView;
import com.dbvr.imglibrary.widget.recyclerview.MultiTypeSupport;
...
public class SelectImageActivity extends BaseActivity implements ImageFolderView.ImageFolderViewListener, ImageAdapter.onCameraClickListener, View.OnClickListener {
    ...
    private void setupSelectedImages() {
        ...
        ArrayList<Image> selectImages = null;
        if (null == name || name.equals("")){
            selectImages = intent.getParcelableArrayListExtra("selected_images");
        }else {
            selectImages = intent.getParcelableArrayListExtra(name);
        }
    ...
    private MultiTypeSupport<Image> mMultiTypeSupport = new MultiTypeSupport<Image>() {
        @Override
        public int getLayoutId(Image item) {
