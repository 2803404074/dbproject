...
public class JvhuaProgress extends View {
    ...
    public JvhuaProgress(Context context) {
        this(context, null);
    }

    public JvhuaProgress(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JvhuaProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mChangePaint.setColor(context.getResources().getColor(R.color.colorDb3));
