            ...
            if (null != productInfo) {
                for (int i = 0; i < productInfo.size(); i++) {
                    if (lastStr.equals(productInfo.get(i).getGoodsSpecIds())) {
                        ...
                        if (!StringUtils.isEmpty(productInfo.get(i).getDeliveryPrice())) {
                            lastPrice = Double.valueOf(productInfo.get(i).getDeliveryPrice());
                        }
                        ...
                        clike.setBackgroundColor(getResources().getColor(R.color.gray_line));
