...
public class GoodsDetails implements Serializable {
    ...
    private List<GoodsSpecVoList> goodsSpecVoList;//规格信息
    private List<ProductInfoVoList> productInfoVoList;//产品信息
    ...
    public static class GoodsSpecVoList{
        ...
        private List<GoodsSpecList>deliveryGoodsSpecList;
        ...
        public GoodsSpecVoList(String id, String name, List<GoodsSpecList> goodsSpecList) {
            this.id = id;
            this.name = name;
            this.deliveryGoodsSpecList = goodsSpecList;
        }
    ...
    public static class ProductInfoVoList{
        ...
        private String deliveryGoodsSpecIds;//产品552_662
        ...
        public ProductInfoVoList(String id, String name, String number, String deliveryGoodsSpecIds, String sellingPrice, String deliveryPrice, String startingPrice) {
            this.id = id;
            this.name = name;
            this.number = number;
            this.deliveryGoodsSpecIds = deliveryGoodsSpecIds;
        ...
        public String getGoodsSpecIds() {
            return deliveryGoodsSpecIds;
        }

        public void setGoodsSpecIds(String goodsSpecIds) {
            this.deliveryGoodsSpecIds = goodsSpecIds;
        }

        public String getDeliveryGoodsSpecIds() {
            return deliveryGoodsSpecIds;
        }

        public void setDeliveryGoodsSpecIds(String deliveryGoodsSpecIds) {
            this.deliveryGoodsSpecIds = deliveryGoodsSpecIds;
        }
...
//    }
    ...
    public List<GoodsSpecVoList> getGoodsSpecVoList() {
        return goodsSpecVoList;
    }

    public void setGoodsSpecVoList(List<GoodsSpecVoList> goodsSpecVoList) {
        this.goodsSpecVoList = goodsSpecVoList;
    }

    public List<ProductInfoVoList> getProductInfoVoList() {
        return productInfoVoList;
    }

    public void setProductInfoVoList(List<ProductInfoVoList> productInfoVoList) {
